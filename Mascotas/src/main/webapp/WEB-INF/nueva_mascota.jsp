...
<body>
    <div class="form-inputs">
        ...
        <div id="client-form">
            ...
            <div class="module">
                <label for="address">Especie: </label>
                <input type="text" name ="address" class="address" id="Address" placeholder="Enter your address"/>
            </div>
            <div class="module">
            ...
            <div class="module">
                <button id="btnsubmitClient" onclick="submitClient()">Submit</button>
            </div>
        </div>
